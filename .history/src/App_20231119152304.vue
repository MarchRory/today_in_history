...
<template>
  <div
    style="height: 100vh"
    class="flex items-center justify-center w-full py-8 font-mono font-bold text-gray-200 bg-slate-200"
  >
    <div
      class="flex flex-col items-center justify-around w-3/5 h-full overflow-hidden rounded-lg"
    >
      <div class="w-full text-center h-1/6">历史上的今天</div>
      <div class="w-full overflow-auto h-4/6 bg-cyan-200"></div>
