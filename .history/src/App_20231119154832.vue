        ...
        <transition-group name="fade" tag="ul">
          ...
          >
            <div class="flex flex-col w-full h-full">
              <div class="w-full h-8 bg-cyan-300">{{ item.title }}</div>
              <div class="w-full bg-indigo-300 h-3/4 overflow-ellipsis">{{ item.desc }}</div>
              <a class="block w-full py-3" :href="item.url" target="_blank">详情</a>
