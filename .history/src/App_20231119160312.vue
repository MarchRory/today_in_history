      ...
      >
        <transition-group name="fade" tag="ul">
          <li
            ...
            class="flex flex-col w-full px-3 py-2 mb-3 transition-colors border-4 border-transparent rounded-md hover:bg-white hover:border-cyan-300 h-fit bg-zinc-200"
