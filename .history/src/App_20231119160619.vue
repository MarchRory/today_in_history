...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="w-full px-4 py-4 overflow-auto border-4 border-indigo-400 rounded-lg h-5/6 bg-zinc-100"
      >
        <transition-group name="fade" tag="ul">
          <li
            @mouseenter="hoverIndex = index"
            @mouseleave="hoverIndex = -1"
            class="flex flex-col w-full px-3 py-2 mb-3 transition-colors border-4 border-transparent rounded-md hover:cursor-default hover:bg-white hover:border-cyan-300 h-fit bg-zinc-200"
