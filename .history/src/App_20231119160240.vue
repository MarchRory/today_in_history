...
<template>
  ...
  >
    <div
      class="flex flex-col items-center justify-around w-3/5 h-full px-6 overflow-hidden rounded-lg"
    >
      ...
      >
        <transition-group name="fade" tag="ul">
          <li
            ...
            class="flex flex-col w-full px-3 py-2 mb-3 transition-colors border-4 border-transparent rounded-md hover:bg-white hover:border-cyan-50 h-fit bg-zinc-200"
          ...
          >
            <div class="flex flex-col w-full h-full">
              <div
                class="w-full h-8 text-xl"
                :style="{ color: hoverIndex == index ? '#2573ce' : 'black' }"
              >
                {{ item.title }}
              </div>
              <div class="w-full px-4 mt-2 mb-2 h-3/4 verticle indent-8">
                {{ item.desc }}
              </div>
              <a
            ...
            <!--             <div class="w-full py-3 h-fit bg-cyan-200"></div>
            <div
              class="flex-1 h-full bg-teal-200 indent-4 text-overflow-ellipsis"
            >
